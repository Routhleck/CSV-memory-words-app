...
void drawStatus(int wordAmount, int wordMemory, int wordNeedMemory, int wordRest, int wordMaster) {
	...
	outtextxy(350 * uWidth, 20 * uHeight, str[0]);

	outtextxy(430 * uWidth, 20 * uHeight, "已记忆:");
	outtextxy(510 * uWidth, 20 * uHeight, str[1]);

	outtextxy(550 * uWidth, 20 * uHeight, "还需记忆:");
	outtextxy(650 * uWidth, 20 * uHeight, str[2]);

	outtextxy(730 * uWidth, 20 * uHeight, "学习剩余:");
	outtextxy(830 * uWidth, 20 * uHeight, str[3]);

	outtextxy(870 * uWidth, 20 * uHeight, "已掌握:");
	outtextxy(950 * uWidth, 20 * uHeight, str[4]);
